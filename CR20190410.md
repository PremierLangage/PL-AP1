...
Fonctions 
    ...
    - notion de paramètres d'une fonction et de valeur de retour
    ...
    - Ecrire correctement des fonctions réalisant un traitement simple

    - Documenter le rôle des fonctions

    - Tester ses fonctions

    - Savoir décomposer un problème en un ensemble de sous-problèmes

    - Etre capable de décrire pas à pas l'éxécution d'un programme contenant des fonctions
