...
+-----------+-----------+-----------+-----------+-----------+-----------+
| **Connais | **Compréh | **Applica | **Une     | **Synthès | **Évaluat |
| sance**   | ension**  | tion**    | analyse** | e**       | ion**     |
+-----------+-----------+-----------+-----------+-----------+-----------+
| définir   | classer   | appliquer | analyser  | organiser | évaluer   |
+-----------+-----------+-----------+-----------+-----------+-----------+
| identifie | décrire   | calculer  | évaluer   | assembler | évaluer   |
| r         |           |           |           |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
...
|           |           | r         |           | ion       |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| liste     | identifie | employer  | contraste | créer     | décider   |
|           | r         |           |           |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| mémoriser | Localiser | donne des | critiquer | conceptio | estimatio |
|           |           | exemples  |           | n         | n         |
+-----------+-----------+-----------+-----------+-----------+-----------+
| prénom    | paraphras | illustrer | débat     | formuler  | évaluer   |
|           | e         |           |           |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| rappel    | reconnaît | interprét | détermine | gérer     | qualité   |
|           | re        | er        | r         |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
...
|           |           | er        | ier       |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| répéter   | la revue  | organiser | distingue | plan      | taux      |
|           |           |           | r         |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| sélection | suggérer  | entraine  | examiner  | préparer  | réviser   |
| ner       |           | toi       |           |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
| souligner | résumer   | prédire   | expérienc | produire  | But       |
|           |           |           | e         |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
|           | dire      | programme | inspecter | proposer  | sélection |
|           |           |           |           |           | ner       |
+-----------+-----------+-----------+-----------+-----------+-----------+
|           | Traduire  | boutique  | inventair | installer | valeur    |
|           |           |           | e         |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
|           |           | esquisser | question  |           |           |
+-----------+-----------+-----------+-----------+-----------+-----------+
